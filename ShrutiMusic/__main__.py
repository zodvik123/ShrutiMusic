...
# ------------ Flask Dummy Server for Render/Koyeb ------------ #
flask_app = Flask(__name__)

@flask_app.route("/")
def home():
    return "\xe2\x9c\x85\x20\x53\x68\x72\x75\x74\x69\x20\x4d\x75\x73\x69\x63\x20\x42\x6f\x74\x20\x69\x73\x20\x41\x6c\x69\x76\x65\x21"
...
async def init():
    ...
    LOGGER("ShrutiMusic").info(
        ""
    )
